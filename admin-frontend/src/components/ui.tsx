...
export function Logo({ size = 28, mono = false, className = '' }: LogoProps) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" className={className} aria-label="BookFlow">
  ...
  return (
    <div className={`flex items-center gap-2 ${className}`}>
      ...
      <div className="leading-none">
        <div className="text-[15px] font-semibold tracking-tight text-ink-900">BookFlow</div>
