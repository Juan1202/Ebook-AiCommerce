...
const AsistentePage = () => {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      text: "Hola, soy el asistente comercial de BookFlow. Puedes preguntarme sobre disponibilidad de libros, precios, categorías o cualquier consulta del catálogo.",
    },
  ]);
