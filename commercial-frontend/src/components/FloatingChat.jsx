...
const SUGGESTIONS = [
  "¿Qué libros de programación tienen?",
  "¿Hay libros nuevos esta semana?",
  "Busco algo de filosofía clásica",
];
          ...
          <div className="fcp__header">
            ...
            <div className="fcp__header-info">
              <div className="fcp__header-title-row">
                <span className="fcp__header-title">BookFlow AI</span>
              ...
              <>
                <div className="fcp__msg fcp__msg--ai">
                  ...
                  <span className="fcp__msg-text">
                    ¡Hola! Puedo ayudarte a encontrar libros, consultar precios y disponibilidad.
                  </span>
                </div>
