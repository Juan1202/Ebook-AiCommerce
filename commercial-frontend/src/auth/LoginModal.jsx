      ...
      >
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <span style={{ fontWeight: 800, fontSize: '0.95rem', color: '#f7f8fa', letterSpacing: '-0.01em' }}>BookFlow</span>
          </div>
          <button
            onClick={onClose}
            style={{
...
const btnPrimary = (disabled) => ({
  display: 'block', width: '100%',
  padding: '12px',
  background: disabled ? '#3d3f4a' : '#f59e0b',
  ...
  fontFamily: 'inherit',
  transition: 'all 0.15s',
  boxShadow: disabled ? 'none' : '0 4px 16px rgba(245,158,11,0.3)',
